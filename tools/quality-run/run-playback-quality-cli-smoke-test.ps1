...
'@ | Set-Content -LiteralPath $skipReportPath -Encoding UTF8
    ...
    if ($analysisSet.evaluationVersion -ne 'playback-quality-v0.7') {
        throw 'Expected analyze-report-set output evaluationVersion playback-quality-v0.7.'
    }
...
'@ | Set-Content -LiteralPath $manifestPath -Encoding UTF8
    ...
    if ($runPlan.evaluationVersion -ne 'playback-quality-v0.7') {
        throw 'Expected playback quality CLI plan-runs output evaluationVersion playback-quality-v0.7.'
    }
    ...
    if ($materializedBaselineSummary.schemaVersion -ne 1 -or
        $materializedBaselineSummary.evaluationVersion -ne 'playback-quality-v0.7' -or
...
'@ | Set-Content -LiteralPath $candidateEvaluationManifestPath -Encoding UTF8
    ...
    if ($candidateEvaluation.evaluationVersion -ne 'playback-quality-v0.7') {
        throw 'Expected playback quality CLI evaluate-candidate output evaluationVersion playback-quality-v0.7.'
    }
