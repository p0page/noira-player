...
namespace winrt::NoiraPlayer::Native::implementation
{
    struct NativePlaybackStatus : NativePlaybackStatusT<NativePlaybackStatus>
    {
        ...
        NoiraPlayer::Native::NativeHdrStatus HdrStatus() const noexcept;
        void HdrStatus(NoiraPlayer::Native::NativeHdrStatus value) noexcept;
    ...
    private:
        NoiraPlayer::Native::NativeHdrStatus m_hdrStatus{NoiraPlayer::Native::NativeHdrStatus::NativeHdrStatus_Unknown};
