...
{
    NoiraPlayer::Native::NativeHdrStatus NativePlaybackStatus::HdrStatus() const noexcept
    {
        return m_hdrStatus;
    }

    void NativePlaybackStatus::HdrStatus(NoiraPlayer::Native::NativeHdrStatus value) noexcept
    {
        m_hdrStatus = value;
    }
