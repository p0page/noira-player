    ...
    public static class PlaybackQualitySignalCatalog
    {
        private static readonly IReadOnlyList<PlaybackQualityReportSignalDescriptor> ReportSignalList =
            new List<PlaybackQualityReportSignalDescriptor>
            {
                ...
                new PlaybackQualityReportSignalDescriptor("execution.observedSampleWallClockDurationMs", "execution", "observedSampleWallClockDurationMs"),
                ...
                new PlaybackQualityReportSignalDescriptor("buffers.playbackDemuxReadDurationMs", "buffers", "playbackDemuxReadDurationMs"),
                new PlaybackQualityReportSignalDescriptor("buffers.playbackDemuxPacketCount", "buffers", "playbackDemuxPacketCount"),
                new PlaybackQualityReportSignalDescriptor("buffers.playbackDemuxBytes", "buffers", "playbackDemuxBytes"),
                new PlaybackQualityReportSignalDescriptor("buffers.playbackTransportProvider", "buffers", "playbackTransportProvider"),
                new PlaybackQualityReportSignalDescriptor("buffers.playbackTransportCallEvidenceStatus", "buffers", "playbackTransportCallEvidenceStatus"),
                new PlaybackQualityReportSignalDescriptor("buffers.playbackTransportReadCalls", "buffers", "playbackTransportReadCalls"),
                new PlaybackQualityReportSignalDescriptor("buffers.playbackTransportSeekCalls", "buffers", "playbackTransportSeekCalls"),
                new PlaybackQualityReportSignalDescriptor("buffers.playbackTransportReadWaitMs", "buffers", "playbackTransportReadWaitMs"),
                new PlaybackQualityReportSignalDescriptor("buffers.playbackTransportSeekWaitMs", "buffers", "playbackTransportSeekWaitMs"),
                new PlaybackQualityReportSignalDescriptor("buffers.playbackTransportSeekDistanceBytes", "buffers", "playbackTransportSeekDistanceBytes"),
                ...
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.open-input.transportProvider", "startup.stages.components", "transportProvider"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.open-input.transportCallEvidenceStatus", "startup.stages.components", "transportCallEvidenceStatus"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.open-input.transportReadCalls", "startup.stages.components", "transportReadCalls"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.open-input.transportSeekCalls", "startup.stages.components", "transportSeekCalls"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.open-input.transportReadWaitMs", "startup.stages.components", "transportReadWaitMs"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.open-input.transportSeekWaitMs", "startup.stages.components", "transportSeekWaitMs"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.open-input.transportSeekDistanceBytes", "startup.stages.components", "transportSeekDistanceBytes"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.find-stream-info.transportProvider", "startup.stages.components", "transportProvider"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.find-stream-info.transportCallEvidenceStatus", "startup.stages.components", "transportCallEvidenceStatus"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.find-stream-info.transportReadCalls", "startup.stages.components", "transportReadCalls"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.find-stream-info.transportSeekCalls", "startup.stages.components", "transportSeekCalls"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.find-stream-info.transportReadWaitMs", "startup.stages.components", "transportReadWaitMs"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.find-stream-info.transportSeekWaitMs", "startup.stages.components", "transportSeekWaitMs"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.ffmpeg.find-stream-info.transportSeekDistanceBytes", "startup.stages.components", "transportSeekDistanceBytes"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.startup-seek.transportProvider", "startup.stages.components", "transportProvider"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.startup-seek.transportCallEvidenceStatus", "startup.stages.components", "transportCallEvidenceStatus"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.startup-seek.transportReadCalls", "startup.stages.components", "transportReadCalls"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.startup-seek.transportSeekCalls", "startup.stages.components", "transportSeekCalls"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.startup-seek.transportReadWaitMs", "startup.stages.components", "transportReadWaitMs"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.startup-seek.transportSeekWaitMs", "startup.stages.components", "transportSeekWaitMs"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.startup-seek.transportSeekDistanceBytes", "startup.stages.components", "transportSeekDistanceBytes"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.first-frame.demux-read.transportProvider", "startup.stages.components", "transportProvider"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.first-frame.demux-read.transportCallEvidenceStatus", "startup.stages.components", "transportCallEvidenceStatus"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.first-frame.demux-read.transportReadCalls", "startup.stages.components", "transportReadCalls"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.first-frame.demux-read.transportSeekCalls", "startup.stages.components", "transportSeekCalls"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.first-frame.demux-read.transportReadWaitMs", "startup.stages.components", "transportReadWaitMs"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.first-frame.demux-read.transportSeekWaitMs", "startup.stages.components", "transportSeekWaitMs"),
                new PlaybackQualityReportSignalDescriptor("startup.stage.native.open.component.native.first-frame.demux-read.transportSeekDistanceBytes", "startup.stages.components", "transportSeekDistanceBytes"),
                ...
                new PlaybackQualityReportSignalDescriptor("position.seekPacketCacheEnabled", "position", "seekPacketCacheEnabled"),
                new PlaybackQualityReportSignalDescriptor("position.seekPacketCacheHit", "position", "seekPacketCacheHit"),
                new PlaybackQualityReportSignalDescriptor("position.seekPacketCachePacketCount", "position", "seekPacketCachePacketCount"),
                new PlaybackQualityReportSignalDescriptor("position.seekPacketCacheBytes", "position", "seekPacketCacheBytes"),
                new PlaybackQualityReportSignalDescriptor("position.seekPacketCacheWindowDurationTicks", "position", "seekPacketCacheWindowDurationTicks"),
                new PlaybackQualityReportSignalDescriptor("position.seekFallbackReason", "position", "seekFallbackReason"),
                ...
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeDurationMsP50", "timing", "videoDecodeDurationMsP50"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeDurationMsP95", "timing", "videoDecodeDurationMsP95"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeDurationMsP99", "timing", "videoDecodeDurationMsP99"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeDurationMsMax", "timing", "videoDecodeDurationMsMax"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeDeviceMode", "timing", "videoDecodeDeviceMode"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeSynchronizationMode", "timing", "videoDecodeSynchronizationMode"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeWorkerActive", "timing", "videoDecodeWorkerActive"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeQueueCapacity", "timing", "videoDecodeQueueCapacity"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeQueueMaxDepth", "timing", "videoDecodeQueueMaxDepth"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeQueueProducerWaitCount", "timing", "videoDecodeQueueProducerWaitCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecoderSendPacketEagainCount", "timing", "videoDecoderSendPacketEagainCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecoderDoubleEagainRetryCount", "timing", "videoDecoderDoubleEagainRetryCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecoderDoubleEagainRecoveryCount", "timing", "videoDecoderDoubleEagainRecoveryCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecoderDoubleEagainExhaustedCount", "timing", "videoDecoderDoubleEagainExhaustedCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodePacketReadDurationMsP50", "timing", "videoDecodePacketReadDurationMsP50"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodePacketReadDurationMsP95", "timing", "videoDecodePacketReadDurationMsP95"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeSendPacketDurationMsP50", "timing", "videoDecodeSendPacketDurationMsP50"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeSendPacketDurationMsP95", "timing", "videoDecodeSendPacketDurationMsP95"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeReceiveFrameDurationMsP50", "timing", "videoDecodeReceiveFrameDurationMsP50"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeReceiveFrameDurationMsP95", "timing", "videoDecodeReceiveFrameDurationMsP95"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeFrameMaterializeDurationMsP50", "timing", "videoDecodeFrameMaterializeDurationMsP50"),
                new PlaybackQualityReportSignalDescriptor("timing.videoDecodeFrameMaterializeDurationMsP95", "timing", "videoDecodeFrameMaterializeDurationMsP95"),
                new PlaybackQualityReportSignalDescriptor("timing.videoRenderDurationMsP50", "timing", "videoRenderDurationMsP50"),
                new PlaybackQualityReportSignalDescriptor("timing.videoRenderDurationMsP95", "timing", "videoRenderDurationMsP95"),
                new PlaybackQualityReportSignalDescriptor("timing.videoRenderDurationMsP99", "timing", "videoRenderDurationMsP99"),
                new PlaybackQualityReportSignalDescriptor("timing.videoRenderDurationMsMax", "timing", "videoRenderDurationMsMax"),
                new PlaybackQualityReportSignalDescriptor("timing.videoRenderDirectCopyFrameCount", "timing", "videoRenderDirectCopyFrameCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoRenderVideoProcessorFrameCount", "timing", "videoRenderVideoProcessorFrameCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoRenderBgraFrameCount", "timing", "videoRenderBgraFrameCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoRenderPostProcessFrameCount", "timing", "videoRenderPostProcessFrameCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorSetupCpuSampleCount", "timing", "videoProcessorSetupCpuSampleCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorSetupCpuDurationMsP50", "timing", "videoProcessorSetupCpuDurationMsP50"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorSetupCpuDurationMsP95", "timing", "videoProcessorSetupCpuDurationMsP95"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorSetupCpuDurationMsP99", "timing", "videoProcessorSetupCpuDurationMsP99"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorSetupCpuDurationMsMax", "timing", "videoProcessorSetupCpuDurationMsMax"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorViewTargetCpuSampleCount", "timing", "videoProcessorViewTargetCpuSampleCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorViewTargetCpuDurationMsP50", "timing", "videoProcessorViewTargetCpuDurationMsP50"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorViewTargetCpuDurationMsP95", "timing", "videoProcessorViewTargetCpuDurationMsP95"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorViewTargetCpuDurationMsP99", "timing", "videoProcessorViewTargetCpuDurationMsP99"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorViewTargetCpuDurationMsMax", "timing", "videoProcessorViewTargetCpuDurationMsMax"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorClearCpuSampleCount", "timing", "videoProcessorClearCpuSampleCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorClearCpuDurationMsP50", "timing", "videoProcessorClearCpuDurationMsP50"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorClearCpuDurationMsP95", "timing", "videoProcessorClearCpuDurationMsP95"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorClearCpuDurationMsP99", "timing", "videoProcessorClearCpuDurationMsP99"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorClearCpuDurationMsMax", "timing", "videoProcessorClearCpuDurationMsMax"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorBltCpuSampleCount", "timing", "videoProcessorBltCpuSampleCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorBltCpuDurationMsP50", "timing", "videoProcessorBltCpuDurationMsP50"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorBltCpuDurationMsP95", "timing", "videoProcessorBltCpuDurationMsP95"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorBltCpuDurationMsP99", "timing", "videoProcessorBltCpuDurationMsP99"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorBltCpuDurationMsMax", "timing", "videoProcessorBltCpuDurationMsMax"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorPostProcessCpuSampleCount", "timing", "videoProcessorPostProcessCpuSampleCount"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorPostProcessCpuDurationMsP50", "timing", "videoProcessorPostProcessCpuDurationMsP50"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorPostProcessCpuDurationMsP95", "timing", "videoProcessorPostProcessCpuDurationMsP95"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorPostProcessCpuDurationMsP99", "timing", "videoProcessorPostProcessCpuDurationMsP99"),
                new PlaybackQualityReportSignalDescriptor("timing.videoProcessorPostProcessCpuDurationMsMax", "timing", "videoProcessorPostProcessCpuDurationMsMax"),
                ...
                new PlaybackQualityReportSignalDescriptor("readRecovery.readErrorCount", "readRecovery", "readErrorCount"),
                new PlaybackQualityReportSignalDescriptor("readRecovery.readRetryCount", "readRecovery", "readRetryCount"),
                new PlaybackQualityReportSignalDescriptor("readRecovery.readRecoveryCount", "readRecovery", "readRecoveryCount"),
                new PlaybackQualityReportSignalDescriptor("readRecovery.maxConsecutiveReadErrors", "readRecovery", "maxConsecutiveReadErrors"),
                new PlaybackQualityReportSignalDescriptor("readRecovery.lastReadErrorCode", "readRecovery", "lastReadErrorCode"),
                new PlaybackQualityReportSignalDescriptor("readRecovery.fatalReadErrorCode", "readRecovery", "fatalReadErrorCode"),
                new PlaybackQualityReportSignalDescriptor("readRecovery.lastReadRecoveryDurationMs", "readRecovery", "lastReadRecoveryDurationMs"),
