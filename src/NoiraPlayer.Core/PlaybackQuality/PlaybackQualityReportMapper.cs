...
namespace NoiraPlayer.Core.PlaybackQuality
{
    public static class PlaybackQualityReportMapper
    {
            ...
            PlaybackQualityMetricsSnapshot metrics)
        {
            ...
            report.Timing.VideoDecoderSendPacketEagainCount = metrics.VideoDecoderSendPacketEagainCount;
            report.Timing.VideoDecoderDoubleEagainRetryCount = metrics.VideoDecoderDoubleEagainRetryCount;
            report.Timing.VideoDecoderDoubleEagainRecoveryCount = metrics.VideoDecoderDoubleEagainRecoveryCount;
            report.Timing.VideoDecoderDoubleEagainExhaustedCount = metrics.VideoDecoderDoubleEagainExhaustedCount;
            ...
            report.Timing.VideoRenderDirectCopyFrameCount = metrics.VideoRenderDirectCopyFrameCount;
            report.Timing.VideoRenderVideoProcessorFrameCount = metrics.VideoRenderVideoProcessorFrameCount;
            report.Timing.VideoRenderBgraFrameCount = metrics.VideoRenderBgraFrameCount;
            report.Timing.VideoRenderPostProcessFrameCount = metrics.VideoRenderPostProcessFrameCount;
            report.Timing.VideoProcessorSetupCpuSampleCount = metrics.VideoProcessorSetupCpuSampleCount;
            report.Timing.VideoProcessorSetupCpuDurationMsP50 = metrics.VideoProcessorSetupCpuDurationMsP50;
            report.Timing.VideoProcessorSetupCpuDurationMsP95 = metrics.VideoProcessorSetupCpuDurationMsP95;
            report.Timing.VideoProcessorSetupCpuDurationMsP99 = metrics.VideoProcessorSetupCpuDurationMsP99;
            report.Timing.VideoProcessorSetupCpuDurationMsMax = metrics.VideoProcessorSetupCpuDurationMsMax;
            report.Timing.VideoProcessorViewTargetCpuSampleCount = metrics.VideoProcessorViewTargetCpuSampleCount;
            report.Timing.VideoProcessorViewTargetCpuDurationMsP50 = metrics.VideoProcessorViewTargetCpuDurationMsP50;
            report.Timing.VideoProcessorViewTargetCpuDurationMsP95 = metrics.VideoProcessorViewTargetCpuDurationMsP95;
            report.Timing.VideoProcessorViewTargetCpuDurationMsP99 = metrics.VideoProcessorViewTargetCpuDurationMsP99;
            report.Timing.VideoProcessorViewTargetCpuDurationMsMax = metrics.VideoProcessorViewTargetCpuDurationMsMax;
            report.Timing.VideoProcessorClearCpuSampleCount = metrics.VideoProcessorClearCpuSampleCount;
            report.Timing.VideoProcessorClearCpuDurationMsP50 = metrics.VideoProcessorClearCpuDurationMsP50;
            report.Timing.VideoProcessorClearCpuDurationMsP95 = metrics.VideoProcessorClearCpuDurationMsP95;
            report.Timing.VideoProcessorClearCpuDurationMsP99 = metrics.VideoProcessorClearCpuDurationMsP99;
            report.Timing.VideoProcessorClearCpuDurationMsMax = metrics.VideoProcessorClearCpuDurationMsMax;
            report.Timing.VideoProcessorBltCpuSampleCount = metrics.VideoProcessorBltCpuSampleCount;
            report.Timing.VideoProcessorBltCpuDurationMsP50 = metrics.VideoProcessorBltCpuDurationMsP50;
            report.Timing.VideoProcessorBltCpuDurationMsP95 = metrics.VideoProcessorBltCpuDurationMsP95;
            report.Timing.VideoProcessorBltCpuDurationMsP99 = metrics.VideoProcessorBltCpuDurationMsP99;
            report.Timing.VideoProcessorBltCpuDurationMsMax = metrics.VideoProcessorBltCpuDurationMsMax;
            report.Timing.VideoProcessorPostProcessCpuSampleCount = metrics.VideoProcessorPostProcessCpuSampleCount;
            report.Timing.VideoProcessorPostProcessCpuDurationMsP50 = metrics.VideoProcessorPostProcessCpuDurationMsP50;
            report.Timing.VideoProcessorPostProcessCpuDurationMsP95 = metrics.VideoProcessorPostProcessCpuDurationMsP95;
            report.Timing.VideoProcessorPostProcessCpuDurationMsP99 = metrics.VideoProcessorPostProcessCpuDurationMsP99;
            report.Timing.VideoProcessorPostProcessCpuDurationMsMax = metrics.VideoProcessorPostProcessCpuDurationMsMax;
