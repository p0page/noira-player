...
using winrt::NextGenEmby::Native::implementation::IsUnsupportedPureDolbyVision;
using winrt::NextGenEmby::Native::implementation::TryParseDolbyVisionConfigurationRecord;
