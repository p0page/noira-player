...
int main()
{
    ...
    assert(PlaybackFramePacing::AudioAheadWaitDuration(1'333'333, 1'000'000, true).count() == 21'333);
    assert(PlaybackFramePacing::AudioAheadWaitDuration(1'115'000, 1'000'000, true).count() == 1'500);
