...
public sealed class PlaybackQualityReportAnalyzerTests
{
    ...
    public void Analyze_Adds_Investigation_Hints_For_Each_Failure_Area()
    {
        ...
        Assert.Contains(analysis.InvestigationHints, hint =>
            ...
            hint.CodeTargets.Contains("src/NoiraPlayer.Native/Media/DxgiColorSpaceMapper.cpp") &&
            hint.CodeTargets.Contains("src/NoiraPlayer.Native/DxDeviceResources.cpp") &&
        ...
        Assert.Contains(analysis.InvestigationHints, hint =>
            ...
            hint.CodeTargets.Contains("src/NoiraPlayer.Native/Media/FramePacing.h") &&
            hint.CodeTargets.Contains("src/NoiraPlayer.Native/Media/PlaybackGraph.cpp") &&
            hint.CodeTargets.Contains("src/NoiraPlayer.Core/PlaybackQuality/PlaybackRefreshRatePolicy.cs") &&
    ...
    public void Analyze_Adds_Evidence_Collection_Hint_When_Failed_Report_Has_Missing_Evidence()
    {
        ...
        Assert.Contains(analysis.InvestigationHints, hint =>
            ...
            hint.CodeTargets.Contains("src/NoiraPlayer.Core/PlaybackQuality/PlaybackQualityReportMapper.cs") &&
    ...
    public void Analyze_Orders_Triage_Steps_By_Failure_Priority_For_Multi_Failure_Report()
    {
        ...
        Assert.Contains("src/NoiraPlayer.Native/Media/DxgiColorSpaceMapper.cpp", analysis.TriageSteps[0].CodeTargets);
    ...
    public void Analyze_Reports_Video_Pipeline_Stage_Timing_Evidence()
    {
        ...
        report.Timing.VideoDecodePacketReadDurationMsP50 = 0.5;
        report.Timing.VideoDecodePacketReadDurationMsP95 = 2.5;
        report.Timing.VideoDecodeSendPacketDurationMsP50 = 0.25;
        report.Timing.VideoDecodeSendPacketDurationMsP95 = 1.25;
        report.Timing.VideoDecodeReceiveFrameDurationMsP50 = 2.0;
        report.Timing.VideoDecodeReceiveFrameDurationMsP95 = 18.0;
        report.Timing.VideoDecodeFrameMaterializeDurationMsP50 = 1.0;
        report.Timing.VideoDecodeFrameMaterializeDurationMsP95 = 9.0;
        ...
        Assert.Contains("timing.videoDecodePacketReadDurationMsP50", analysis.EvidenceSignals);
        Assert.Contains("timing.videoDecodePacketReadDurationMsP95", analysis.EvidenceSignals);
        Assert.Contains("timing.videoDecodeSendPacketDurationMsP50", analysis.EvidenceSignals);
        Assert.Contains("timing.videoDecodeSendPacketDurationMsP95", analysis.EvidenceSignals);
        Assert.Contains("timing.videoDecodeReceiveFrameDurationMsP50", analysis.EvidenceSignals);
        Assert.Contains("timing.videoDecodeReceiveFrameDurationMsP95", analysis.EvidenceSignals);
        Assert.Contains("timing.videoDecodeFrameMaterializeDurationMsP50", analysis.EvidenceSignals);
        Assert.Contains("timing.videoDecodeFrameMaterializeDurationMsP95", analysis.EvidenceSignals);
    ...
    public void Analyze_Reports_Audio_Ahead_Wait_Duration_Timing_Evidence()
    {
        ...
        report.Timing.AudioAheadWaitPassDurationMsP50 = 7.0;
        report.Timing.AudioAheadWaitPassDurationMsP95 = 12.0;
        report.Timing.AudioAheadWaitPassDurationMsP99 = 16.0;
        report.Timing.AudioAheadWaitPassDurationMsMax = 18.0;
        report.Timing.AudioAheadWaitPassTargetMsP50 = 3.0;
        report.Timing.AudioAheadWaitPassTargetMsP95 = 4.0;
        report.Timing.AudioAheadWaitPassTargetMsP99 = 5.0;
        report.Timing.AudioAheadWaitPassTargetMsMax = 6.0;
        report.Timing.AudioAheadWaitPassOversleepMsP50 = 4.0;
        ...
        Assert.Contains("timing.audioAheadWaitPassDurationMsP50", analysis.EvidenceSignals);
        Assert.Contains("timing.audioAheadWaitPassDurationMsP95", analysis.EvidenceSignals);
        Assert.Contains("timing.audioAheadWaitPassDurationMsP99", analysis.EvidenceSignals);
        Assert.Contains("timing.audioAheadWaitPassDurationMsMax", analysis.EvidenceSignals);
        Assert.Contains("timing.audioAheadWaitPassTargetMsP50", analysis.EvidenceSignals);
        Assert.Contains("timing.audioAheadWaitPassTargetMsP95", analysis.EvidenceSignals);
        Assert.Contains("timing.audioAheadWaitPassTargetMsP99", analysis.EvidenceSignals);
        Assert.Contains("timing.audioAheadWaitPassTargetMsMax", analysis.EvidenceSignals);
        Assert.Contains("timing.audioAheadWaitPassOversleepMsP50", analysis.EvidenceSignals);
    ...
    public void Analyze_Uses_Starvation_Driven_Frame_Pacing_Hint_When_Buffering_Fails_With_Frame_Pacing()
    {
        ...
        Assert.Contains(analysis.InvestigationHints, hint =>
            ...
            hint.CodeTargets.Contains("src/NoiraPlayer.Native/Media/VideoDecoder.cpp") &&
            hint.CodeTargets.Contains("src/NoiraPlayer.Native/Media/AudioDecoder.cpp") &&
            hint.CodeTargets.Contains("src/NoiraPlayer.Native/Media/AudioRenderer.cpp") &&
    ...
    public void Analyze_Classifies_Frame_Pacing_As_Sample_Insufficient_When_Rendered_Frame_Sample_Is_Too_Short()
    {
        ...
        Assert.Contains(analysis.InvestigationHints, hint =>
            ...
            hint.CodeTargets.Contains("src/NoiraPlayer.Core/PlaybackQuality/PlaybackQualityReportComposer.cs") &&
            hint.CodeTargets.Contains("src/NoiraPlayer.Native/NativePlaybackQualityMetrics.cpp") &&
            hint.CodeTargets.Contains("src/NoiraPlayer.Native/Media/PlaybackGraph.cpp") &&
