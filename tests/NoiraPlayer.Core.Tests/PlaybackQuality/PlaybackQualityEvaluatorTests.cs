    ...
    public void Evaluate_Passes_Complete_Normalized_Native_Seek_Evidence()
    {
        var report = new PlaybackQualityReport
        {
            ...
            Position = new PlaybackQualityPosition
            {
                ...
                SeekLockWaitDurationMs = 1,
                SeekExecutionDurationMs = 119,
                SeekQuiesceDurationMs = 2,
                SeekReplayPreparationDurationMs = 1,
                SeekStateResetDurationMs = 2,
                SeekMediaRepositionDurationMs = 100,
                SeekDependentDecoderFlushDurationMs = 3,
                SeekPrerollRenderDurationMs = 8,
                SeekWorkerRestartDurationMs = 3,
