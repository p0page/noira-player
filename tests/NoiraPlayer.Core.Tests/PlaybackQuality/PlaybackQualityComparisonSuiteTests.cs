...
public sealed class PlaybackQualityComparisonSuiteTests
{
    ...
    public void Summarize_CollectsEvidence_When_Any_Comparison_Is_Weak_And_None_Regress()
    {
        ...
        Assert.Contains("src/NoiraPlayer.Core/PlaybackQuality/PlaybackQualityReportMapper.cs", suite.CodeTargets);
        Assert.Contains("src/NoiraPlayer.Native/NativePlaybackQualityMetrics.cpp", suite.CodeTargets);
    }
    ...
    public void Summarize_Emits_NextAction_For_Evidence_Blockers()
    {
        ...
        Assert.Contains("src/NoiraPlayer.Core/PlaybackQuality/PlaybackQualityReportMapper.cs", nextAction.CodeTargets);
    ...
    public void Summarize_Emits_NextAction_For_Candidate_Regressions()
    {
        ...
        Assert.Contains("src/NoiraPlayer.Native/Media/AudioRenderer.cpp", nextAction.CodeTargets);
    }
    ...
    public void Summarize_Emits_Case_Summaries_For_Model_Localization()
    {
        ...
        Assert.Contains("src/NoiraPlayer.Native/Media/FramePacing.h", caseSummary.CodeTargets);
        Assert.Contains("src/NoiraPlayer.Native/Media/PlaybackGraph.cpp", caseSummary.CodeTargets);
    }
    ...
    public void Summarize_TargetFailureAreas_Uses_Playback_Failure_Priority()
    {
        ...
        Assert.Contains("src/NoiraPlayer.Native/Media/DxgiColorSpaceMapper.cpp", suite.CodeTargets);
