...
using winrt::NoiraPlayer::Native::implementation::CreateHlgReferenceHdr10Metadata;
using winrt::NoiraPlayer::Native::implementation::ShouldOutputHdr10ForFrame;
using winrt::NoiraPlayer::Native::implementation::VideoHdrKind;
