    ...
    try
    {
        ...
        if (options.Scenario == L"audio-switch")
        {
            if (audioStreamIndexes.size() >= 2)
            {
                ...
                try
                {
                    auto const switchTiming = graph.SwitchAudioStream(audioSwitch.StreamIndex);
                    audioSwitch.LockWaitDurationMs = switchTiming.LockWaitDurationMs;
                    audioSwitch.ExecutionDurationMs = switchTiming.ExecutionDurationMs;
                    audioSwitch.QuiesceDurationMs = switchTiming.QuiesceDurationMs;
        ...
        auto runSubtitleSwitch = [&graph, &waitForEvidence, &excludedSampleDuration](int32_t streamIndex, bool pauseBeforeSwitch)
        {
            ...
            try
            {
                ...
                auto const switchTiming = graph.SwitchSubtitleStream(streamIndex);
                outcome.LockWaitDurationMs = switchTiming.LockWaitDurationMs;
                outcome.ExecutionDurationMs = switchTiming.ExecutionDurationMs;
                outcome.QuiesceDurationMs = switchTiming.QuiesceDurationMs;
                ...
                auto const playbackRecovered = waitForEvidence([&]()
                {
                    outcome.SelectedStreamIndex = graph.SelectedSubtitleStreamIndex().value_or(-1);
                    outcome.PositionAfterResumeTicks = graph.CurrentPositionTicks();
                    outcome.RenderedFramesAfter = graph.QualityMetricsSnapshot().RenderedVideoFrames;
                    ...
                    return outcome.SelectedStreamIndex == outcome.StreamIndex &&
                        outcome.RenderedFramesAfter > outcome.RenderedFramesBefore &&
                        pauseAndResumeObserved;
                });
                outcome.RecoveryDurationMs =
                    std::chrono::duration<double, std::milli>(
                        std::chrono::steady_clock::now() - interactionStartedAt).count();
                auto const cueRendered = playbackRecovered && waitForEvidence([&]()
                {
                    outcome.CueCountAfter = graph.SubtitleCueRenderCount();
                    return outcome.CueCountAfter > outcome.CueCountBefore;
                });
                outcome.CueRenderDurationMs =
                    std::chrono::duration<double, std::milli>(
                        std::chrono::steady_clock::now() - interactionStartedAt).count();
                outcome.Status = playbackRecovered && cueRendered ? "completed" : "failed";
            }
            catch (...)
            {
                outcome.RecoveryDurationMs =
                    std::chrono::duration<double, std::milli>(
                        std::chrono::steady_clock::now() - interactionStartedAt).count();
                outcome.CueRenderDurationMs = outcome.RecoveryDurationMs;
                outcome.SelectedStreamIndex = graph.SelectedSubtitleStreamIndex().value_or(-1);
                outcome.CueCountAfter = graph.SubtitleCueRenderCount();
                outcome.RenderedFramesAfter = graph.QualityMetricsSnapshot().RenderedVideoFrames;
        ...
        std::cout << "decodedVideoFrames=" << playbackSnapshot.DecodedVideoFrames
            ...
            << " audioSwitchLockWaitDurationMs=" << audioSwitch.LockWaitDurationMs
            << " audioSwitchExecutionDurationMs=" << audioSwitch.ExecutionDurationMs
            << " audioSwitchQuiesceDurationMs=" << audioSwitch.QuiesceDurationMs
            ...
            << " subtitleSwitch1LockWaitDurationMs=" << subtitleSwitch1.LockWaitDurationMs
            << " subtitleSwitch1ExecutionDurationMs=" << subtitleSwitch1.ExecutionDurationMs
            << " subtitleSwitch1QuiesceDurationMs=" << subtitleSwitch1.QuiesceDurationMs
            ...
            << " subtitleSwitch1RenderedFramesAfter=" << subtitleSwitch1.RenderedFramesAfter
            ...
            << " subtitleSwitch2LockWaitDurationMs=" << subtitleSwitch2.LockWaitDurationMs
            << " subtitleSwitch2ExecutionDurationMs=" << subtitleSwitch2.ExecutionDurationMs
            << " subtitleSwitch2QuiesceDurationMs=" << subtitleSwitch2.QuiesceDurationMs
            ...
            << " subtitleSwitch2RenderedFramesAfter=" << subtitleSwitch2.RenderedFramesAfter
            ...
            << " ffmpegOpenInputTransportSeekWaitMs=" << playbackSnapshot.FfmpegOpenInputTransportCalls.SeekWaitMs
            << " ffmpegOpenInputTransportSeekDistanceBytes=" << playbackSnapshot.FfmpegOpenInputTransportCalls.SeekDistanceBytes
            << " ffmpegOpenInputTransportSizeQueryCalls=" << playbackSnapshot.FfmpegOpenInputTransportCalls.SizeQueryCalls
            << " ffmpegOpenInputTransportDataSeekCalls=" << playbackSnapshot.FfmpegOpenInputTransportCalls.DataSeekCalls
            << " ffmpegOpenInputTransportForwardDataSeekCalls=" << playbackSnapshot.FfmpegOpenInputTransportCalls.ForwardDataSeekCalls
            << " ffmpegOpenInputTransportBackwardDataSeekCalls=" << playbackSnapshot.FfmpegOpenInputTransportCalls.BackwardDataSeekCalls
            << " ffmpegOpenInputTransportNoOpDataSeekCalls=" << playbackSnapshot.FfmpegOpenInputTransportCalls.NoOpDataSeekCalls
            << " ffmpegOpenInputTransportSizeQueryWaitMs=" << playbackSnapshot.FfmpegOpenInputTransportCalls.SizeQueryWaitMs
            << " ffmpegOpenInputTransportDataSeekWaitMs=" << playbackSnapshot.FfmpegOpenInputTransportCalls.DataSeekWaitMs
            << " ffmpegOpenInputTransportForwardDataSeekWaitMs=" << playbackSnapshot.FfmpegOpenInputTransportCalls.ForwardDataSeekWaitMs
            << " ffmpegOpenInputTransportBackwardDataSeekWaitMs=" << playbackSnapshot.FfmpegOpenInputTransportCalls.BackwardDataSeekWaitMs
            << " ffmpegOpenInputTransportNoOpDataSeekWaitMs=" << playbackSnapshot.FfmpegOpenInputTransportCalls.NoOpDataSeekWaitMs
            ...
            << " ffmpegStreamInfoTransportSeekWaitMs=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.SeekWaitMs
            << " ffmpegStreamInfoTransportSeekDistanceBytes=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.SeekDistanceBytes
            << " ffmpegStreamInfoTransportSizeQueryCalls=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.SizeQueryCalls
            << " ffmpegStreamInfoTransportDataSeekCalls=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.DataSeekCalls
            << " ffmpegStreamInfoTransportForwardDataSeekCalls=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.ForwardDataSeekCalls
            << " ffmpegStreamInfoTransportBackwardDataSeekCalls=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.BackwardDataSeekCalls
            << " ffmpegStreamInfoTransportNoOpDataSeekCalls=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.NoOpDataSeekCalls
            << " ffmpegStreamInfoTransportSizeQueryWaitMs=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.SizeQueryWaitMs
            << " ffmpegStreamInfoTransportDataSeekWaitMs=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.DataSeekWaitMs
            << " ffmpegStreamInfoTransportForwardDataSeekWaitMs=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.ForwardDataSeekWaitMs
            << " ffmpegStreamInfoTransportBackwardDataSeekWaitMs=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.BackwardDataSeekWaitMs
            << " ffmpegStreamInfoTransportNoOpDataSeekWaitMs=" << playbackSnapshot.FfmpegStreamInfoTransportCalls.NoOpDataSeekWaitMs
            ...
            << " nativeFirstFrameTransportSeekWaitMs=" << playbackSnapshot.NativeFirstFrameTransportCalls.SeekWaitMs
            << " nativeFirstFrameTransportSeekDistanceBytes=" << playbackSnapshot.NativeFirstFrameTransportCalls.SeekDistanceBytes
