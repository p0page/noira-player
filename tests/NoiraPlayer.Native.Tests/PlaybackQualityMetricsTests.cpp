...
int main()
{
    ...
    metrics.RecordVideoDecodePacketReadDurationMs(0.5);
    metrics.RecordVideoDecodePacketReadDurationMs(1.5);
    metrics.RecordVideoDecodePacketReadDurationMs(2.5);
    metrics.RecordVideoDecodeSendPacketDurationMs(0.25);
    metrics.RecordVideoDecodeSendPacketDurationMs(0.75);
    metrics.RecordVideoDecodeSendPacketDurationMs(1.25);
    metrics.RecordVideoDecodeReceiveFrameDurationMs(2.0);
    metrics.RecordVideoDecodeReceiveFrameDurationMs(8.0);
    metrics.RecordVideoDecodeReceiveFrameDurationMs(18.0);
    metrics.RecordVideoDecodeFrameMaterializeDurationMs(1.0);
    metrics.RecordVideoDecodeFrameMaterializeDurationMs(4.0);
    metrics.RecordVideoDecodeFrameMaterializeDurationMs(9.0);
    ...
    metrics.FfmpegOpenInputTransportCalls.DataSeekWaitMs = 225.0;
    metrics.FfmpegOpenInputTransportCalls.DataSeekDistanceBytes = 4096;
    metrics.FfmpegOpenInputTransportCalls.ForwardDataSeekCalls = 1;
    metrics.FfmpegOpenInputTransportCalls.BackwardDataSeekCalls = 1;
    metrics.FfmpegOpenInputTransportCalls.NoOpDataSeekCalls = 0;
    metrics.FfmpegOpenInputTransportCalls.ForwardDataSeekWaitMs = 200.0;
    metrics.FfmpegOpenInputTransportCalls.BackwardDataSeekWaitMs = 25.0;
    ...
    assert(snapshot.VideoDecodePacketReadDurationMsP50 >= 0.5);
    assert(snapshot.VideoDecodePacketReadDurationMsP95 >= 2.5);
    assert(snapshot.VideoDecodeSendPacketDurationMsP50 >= 0.25);
    assert(snapshot.VideoDecodeSendPacketDurationMsP95 >= 1.25);
    assert(snapshot.VideoDecodeReceiveFrameDurationMsP50 >= 2.0);
    assert(snapshot.VideoDecodeReceiveFrameDurationMsP95 >= 18.0);
    assert(snapshot.VideoDecodeFrameMaterializeDurationMsP50 >= 1.0);
    assert(snapshot.VideoDecodeFrameMaterializeDurationMsP95 >= 9.0);
    ...
    assert(snapshot.FfmpegOpenInputTransportCalls.DataSeekDistanceBytes == 4096);
    assert(snapshot.FfmpegOpenInputTransportCalls.ForwardDataSeekCalls == 1);
    assert(snapshot.FfmpegOpenInputTransportCalls.BackwardDataSeekCalls == 1);
    assert(snapshot.FfmpegOpenInputTransportCalls.NoOpDataSeekCalls == 0);
    assert(snapshot.FfmpegOpenInputTransportCalls.ForwardDataSeekWaitMs == 200.0);
    assert(snapshot.FfmpegOpenInputTransportCalls.BackwardDataSeekWaitMs == 25.0);
