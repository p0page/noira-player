...
- shared Home rail-card resources for media-library tiles, server-section tiles, and Home poster rows, including card dimensions, spacing, type size, corner radius, artwork wash, stronger bottom text scrim, and focused-card scale.
