...
Native implementation should tune acrylic/blur strength, opacity, focus scale, and luminance in Xbox/XAML against real hardware and real media. Tuning may change exact pixel values, but it must preserve these non-negotiables:
...
- OSD material stays subordinate to video and subtitles.
