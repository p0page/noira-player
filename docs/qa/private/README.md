...
```powershell
dotnet run --project tools\NextGenEmby.PlaybackQuality.Cli\NextGenEmby.PlaybackQuality.Cli.csproj -- validate-manifest --manifest docs\qa\private\emby-reference-manifest.local.json --output docs\qa\private\emby-reference-manifest-validation.local.json
```
...
```powershell
dotnet run --project tools\NextGenEmby.PlaybackQuality.Cli\NextGenEmby.PlaybackQuality.Cli.csproj -- plan-runs --manifest docs\qa\private\combined-reference-manifest.local.json --reports-dir docs\qa\private\reports\baseline --duration 60 --output docs\qa\private\combined-run-plan.local.json
```
