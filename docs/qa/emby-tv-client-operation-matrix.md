...
3. Live TV is reachable from the Guide but still needs positive validation on a server that exposes channels. Music has positive fixture validation in 0.1.0.177 and Photos has positive fixture album/photo validation in 0.1.0.182; real-server music, artist hierarchy, and photo libraries remain pending after session restore.
